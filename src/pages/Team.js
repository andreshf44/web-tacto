...
const teamMembers = [
  {
    ...
    img: director,
    bio: "Oriundo de La Unión, Región de los Ríos, artista escénico con más de 20 años de trayectoria en interpretación, dirección, composición y docencia en danza. Ha sido intérprete en danza moderna y contemporánea en compañías destacadas como el Ballet Nacional de Ecuador, Ballet de Cámara del Teatro Municipal de Santiago, entre otras 7 compañías y variados proyectos independientes. Gestor y director de certámenes y festivales de danza y artes escénicas nacionales e internacionales, sus propuestas y creaciones han sido exhibidas en Chile, Ecuador, Perú, Colombia y los EE.UU. Actualmente es director, coreógrafo, terapeuta corporal y educador en movimiento somático.",
  },
  {
    name: "Rebecca Levi",
    role: "Producción · Música",
    img: productora,
  ...
  {
    name: "Claudio Romero",
    role: "Dirección Técnica · Iluminación",
    img: tecnico1,
  ...
  return (
    <section className="team" id="equipo">
      <div className="team__header">
        <div>
          <p className="team__eyebrow">Las personas detrás de Tacto</p>
        ...
        <p className="team__intro">
          Artistas, intérpretes, creadorxs, músicxs, técnicxs y gestorxs
          construyendo una práctica escénica desde distintos lenguajes y
          territorios.
        </p>
      </div>
      ...
      <div className="team__grid">
        {teamMembers.map((member, index) => (
          <button
            type="button"
            className={`team-card team-card--${(index % 4) + 1}`}
            key={member.name}
      ...
      {selectedMember && (
        <div
          ...
          role="dialog"
          aria-modal="true"
          aria-label={`Perfil de ${selectedMember.name}`}
